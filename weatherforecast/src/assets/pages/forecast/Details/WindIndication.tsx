const WindIndication = ({ rotationValue }: { rotationValue: number }) => {
  return (
    <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path transform={`rotate(${rotationValue} 50 50)`} d="M46.377 68.0622C47.5173 71.8631 52.8994 71.863 54.0396 68.0622L59.5833 49.5833L50.2083 18.3333L40.8333 49.5833L46.377 68.0622Z" fill="#000032" />
    </svg>
  );
}
