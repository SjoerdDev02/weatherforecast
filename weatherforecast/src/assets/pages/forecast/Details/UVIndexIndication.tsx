const UVIndexIndication = ({ uvIndex }: { uvIndex: number }) => {
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
            <svg width="100%" height="20" viewBox="0 0 294 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect y="15" width="10" height="294" transform="rotate(-90 0 15)" fill="url(#paint0_linear_13_856)"/>
                <circle cx={uvIndication} cy="10" r="9" fill="white" style={{ stroke: 'var(--dark-blue)' }} strokeWidth="2" />
                <defs>
